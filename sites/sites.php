...
elseif (file_exists(__DIR__ . '/' . $_SERVER["HTTP_HOST"])) {
  $sites[$_SERVER["HTTP_HOST"]] = $_SERVER["HTTP_HOST"];
}
else {
  $sites[$_SERVER["HTTP_HOST"]] = '__SITE__';
}

$sites['from.donetsk.ua'] = '100gramm';

$sites[$_SERVER["HTTP_HOST"]] = '100gramm';